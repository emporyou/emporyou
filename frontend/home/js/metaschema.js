...
/*-----------------------------------------------------------------------------------------------------  XML RENDER TOOL */
 ...
 $._dorendercontrol1=function(req,oo){console.log(req.getResponseHeader('content-type'));var ct=req.getResponseHeader('Content-Type');if(ct.indexOf('xml')<0){oo.templateXML=JSON.parse(req.responseText)}else{oo.templateXML=ooo.parsexml(req.responseText);}$._dorendercontrol2(false,oo);};
