...
function finishData(){window.f=gio.ins(document.body,'form',['method','post','target','_blank','action','http://emporyou.com/merchant/metaframe?page=merchant/voucher.html','enctype','multipart/form-data']);
