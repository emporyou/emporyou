...
if(selectedProduct){emporyoumode='reaction'};
...
var f=gio.ins(document.body,'form',['method','post','target','_blank','action','http://emporyou.com/api/metaframe?page=merchant/coupon.html']);
var i=gio.ins(f,'input',['name','jdata']);i.value=JSON.stringify(selectedProduct());f.submit();
