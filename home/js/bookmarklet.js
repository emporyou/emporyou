...
function finishData(){var f=gio.ins(document.body,'form',['method','post','target','_blank','action','http://emporyou.com/merchant/metaframe?page=merchant/coupon.html','enctype','multipart/form-data']);
...
function _processVariants(){
    var imgSrc=document.getElementsByClassName('img-responsive')[0].src;
    var imgObj={'url':imgSrc,'name':optNum[z].innerHTML,'isvariant':true};
    prodJSON.image.push(imgObj);
    processVariants()
}
