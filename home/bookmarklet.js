...
<html><form id="coupon-form" action="http://emporyou.com" method="post" onsubmit="return false"><div 
class="header-admin"><div class="fontlogo text-logo"><img class="logo-text" src="../img/logo-text.png" /> </div></div><div 
id="form-coupon-container"><div 
id="title-coupon">Crea il tuo coupon</div><div 
id="categorie-testo">Seleziona una categoria</div><div 
id="blue-cont"><textarea 
id="product-title" name="title" placeholder="Nome prodotto..">%title</textarea><textarea 
id="product-altreinfo" name="subtitle" placeholder="Sottotitolo.."> </textarea><div 
id="vaucher-text">Coupon</div><img 
class="logo-coupon" src="../img/logo-text-black.png" /><textarea 
id="product-descrizione" name="description" placeholder="Descrizione.."> </textarea><div 
id="image-target"><input 
type="file" id="files"/><output 
id="list"> </output></div></div><div 
id="dotted-cont"> </div><fieldset 
id="option-cont" name="variants[]"><fieldset 
class="new-option" name="option[]"><textarea class="optionName detail" name="option" placeholder="Opzione.."> </textarea><textarea class="priceName option" name="price" placeholder="Prezzo..">%price</textarea><div class="image-target-option transition-1"><input type="hidden" name="v_id"/><input 
type="file" id="defaultOpt" class="fileso"></div></fieldset><div 
id="add-option" onclick="addOption()" class="adder transition-1">Add option<br/>+</div></fieldset><fieldset 
id="details-cont" name="metafields[]"><div 
id="add-detail" onclick="addDetail()" class="adder transition-1">Add detail<br/>+</div></fieldset><div 
id="blue-cont-head"></div><button 
id="manda-coupon" onclick="sendCoupon()">MANDA COUPON</button><div 
id="svgcont"><svg 
id="svgg" height="100%" width="100%" viewBox="0 0 421 181" preserveAspectRatio="none"><path 
id="Selezione" fill="#EFEFB4" stroke="transparent" stroke-width="1" fill-opacity="1" d="M 61.00,48.27
           C 61.00,48.27 177.00,31.27 177.00,31.27
             ...
             6.00,56.00 61.00,48.27 61.00,48.27 Z" /><path 
id="Selezione" fill="#BA426D" stroke="transparent" stroke-width="1" fill-opacity="0.7" d="M 362.00,3.00
           ...
           C 19.00,57.00 31.00,57.96 31.00,57.96
             ...
             1.00,57.00 19.00,57.00 19.00,57.00 Z" /></svg></div></div></form><form 
id="send-form" style="display:none" action="http://emporyou.com/api/newdeal?k=12&p=12" method="post" enctype="multipart/form-data"><textarea id="send-target" name="jdata"> </textarea></form><form id="send-form" style="display:none" action="http://emporyou.com/api/newdeal?k=12&p=12" method="post" enctype="multipart/form-data"><textarea id="send-target" name="jdata"> </textarea></form></html></rowtype>
</document>
`;
...
ooo.syncrender(document.body,xtpl,prodXML);
