...
Metaschema={CONFIG:{port:8080,ip:'0.0.0.0',dirname:'./static',defaultfile:'index.html',
	...
	pageParameter:'page',separatorParameter:',',urltorecord:{redirect:'/?',parameter:'_id'},
...
metaframe:function(req,res){
   var fn=req.item(Metaschema.CONFIG.pageParameter);
	  ...
	  fs.createReadStream(fn).pipe(replaceStream('%'+Metaschema.CONFIG.dataParameter,json)).pipe(res);
