...
_o2xml:function(n,o){if(n.indexOf('[]')>-1){n=n.replace('[]','')}if(n.indexOf('_')==0){n=n.substr(1);return '<'+n+'>'+o+'</'+n+'>'}var xml='<'+n+'>';var pr;
 for(var prop in o){pr=prop;if(!isNaN(prop)){pr='x'+pr}if(Array.prototype.isPrototypeOf(o[prop])){xml+=this.a2xml(pr,o[prop]);}else if(String.prototype.isPrototypeOf(o[prop])){xml+='<'+n+'>'+o[prop]+'</'+n+'>'}else if(typeof(o[prop])=='object'){xml+=this._o2xml(pr,o[prop]);}else{xml+=this.v2xml(pr,o[prop]);}}return xml+'</'+n+'>';},
a2xml:function(n,a){if(n.indexOf('[]')>-1){n=n.replace('[]','')}var xml='';for(var i=0;i<a.length;i++){console.log(a[i]);if(Array.prototype.isPrototypeOf(a[i])){xml+=this.a2xml(n,a[i]);}else if(String.prototype.isPrototypeOf(a[i])){xml+='<'+n+'>'+a[i]+'</'+n+'>'}else if(typeof(a[i]=='object')){xml+=this._o2xml(n,a[i]);}else{xml+=this.v2xml(n,a[i]);}}return xml;},
