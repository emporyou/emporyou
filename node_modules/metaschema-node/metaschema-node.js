...
_o2xml:function(n,o){if(n.indexOf('[]')>-1){n=n.replace('[]','')}if(n.indexOf('_')==0){n=n.substr(1);return '<'+n+'>'+o+'</'+n+'>'}var xml='<'+n+'>';var pr;
 for(var prop in o){pr=prop;if(Array.prototype.isPrototypeOf(o[prop])){xml+=this.a2xml(pr,o[prop]);}else if(typeof(o[prop])=='object'){xml+=this._o2xml(pr,o[prop]);}else{xml+=this.v2xml(pr,o[prop]);}}return xml+'</'+n+'>';},
