...
findQ:function(req,res){var Q={};
   ...
   Q=Metaschema.findid(req,Q,'id');Q=Metaschema.findid(req,Q,'p');Q=Metaschema.findid(req,Q,'k');
	...
	if(Q.rel){if(String.prototype.isPrototypeOf(Q.rel)){var rr=[];qq=Q.rel.split(Metaschema.CONFIG.separatorParameter);for(qi=0;qi<qq.length;qi++){if(qq[qi]!=''){rr[rr.length]=ObjectID(Metaschema.zeropad(qq[qi]))}}Q.rel={$elemMatch:{key:{$in:rr}}}}}
